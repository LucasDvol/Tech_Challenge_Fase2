...
print(ibovespa.shape)
# descritivo das variáveis: medidas resumo
print(ibovespa.describe().round(2))
...
# 3.1 Seleção de Técnica de Previsão: Neste modelo, usaremos o LSTM, que é eficaz para séries temporais com padrões complexos.
